...
/// Creates a lyout of 600max width for large devices
...
typedef LargeLayoutBuilder = Widget Function(
    BuildContext context, DeviceType device);

class LargeLayoutContainerBuilder extends StatelessWidget {
  final LargeLayoutBuilder builder;
  final double? maxWidth;

  const LargeLayoutContainerBuilder({
    super.key,
    required this.builder,
    this.maxWidth,
  });
