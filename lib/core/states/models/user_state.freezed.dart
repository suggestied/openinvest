...
class _$UserStateDataImpl extends UserStateData {
  const _$UserStateDataImpl({required this.user}) : super._();
...
abstract class UserStateData extends UserState {
  const factory UserStateData({required final User user}) = _$UserStateDataImpl;
  const UserStateData._() : super._();
